...
import { ContratoNavigator } from "./ContratoNavigator";
import { HipotecaNavigator } from "./HipotecaNavigator";
...
export type RootDrawerNavigator = {
    ...
    ContratoNavigator: undefined;
    HipotecaNavigator: undefined;
}
...
const Navigator = () => {
    ...
    return( 
        ...
        >
            ...
            />
            <Drawer.Screen
                name="ContratoNavigator"
                component={ContratoNavigator}
            />
            <Drawer.Screen
                name="HipotecaNavigator"
                component={HipotecaNavigator}
            />
        </Drawer.Navigator>
    );
}
